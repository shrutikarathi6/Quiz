...
<body>
    <div class="header">
        ...
        <!-- <nav class="navbar navbar-default title1"> -->
            <!-- <div  style="background-color: #dddddd; " class="container-fluid"> -->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    if (@$_GET['q'] == 2) {
                        ...
                        echo  '<div class="panel title" style="margin-top:10vh">
                    ...
                    if (@$_GET['q'] == 3) {
                        ...
                        echo  '<div class="panel title" style="margin-top:10vh"><div class="table-responsive">
                        <table class="table table-striped title1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="signinheading" style="font-family:'typo' "><span style="color:orange">Project By</span></h4>
                </div>
